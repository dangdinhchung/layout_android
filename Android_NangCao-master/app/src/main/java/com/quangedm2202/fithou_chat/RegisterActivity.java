...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPassword = (TextInputLayout) findViewById(R.id.reg_display_password);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            userMap.put("status", "Hi there! I'm using FITHOU CHAT App");
                            ...
                            mRegProgress.hide();
                            Toast.makeText(RegisterActivity.this, "Can't create account.Please check a form and try again!", Toast.LENGTH_LONG).show();
                        }
